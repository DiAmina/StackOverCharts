...
request.done(function (output) {
    ...
    //utiliser la fonction getNbDevById pour recuperer le nombre d'année d'experience
    console.log(getNbDevById(output,'YearsCodePro'));
    //utiliser une focntion pour pouvoir selectionner le nombre d'année d'experience
